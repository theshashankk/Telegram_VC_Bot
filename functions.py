...
async def generate_cover_square(requested_by, title, artist, duration, thumbnail):
    ...
    image2 = Image.open("etc/coffinx.png")
    ...
    font = ImageFont.truetype("etc/MADE Evolve Sans Medium EVO (PERSONAL USE).otf", 20)
...
async def generate_cover(requested_by, title, views, duration, thumbnail):
    ...
    img = Image.open("temp.png")
    draw = ImageDraw.Draw(img)
    font = ImageFont.truetype("etc/MADE Evolve Sans Medium EVO (PERSONAL USE).otf", 32)
